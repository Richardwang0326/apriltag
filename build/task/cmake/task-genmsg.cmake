...
message(STATUS "task: 0 messages, 1 services")
...
get_filename_component(_filename "/home/arg/apriltag/src/task/srv/assignment.srv" NAME_WE)
add_custom_target(_task_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "task" "/home/arg/apriltag/src/task/srv/assignment.srv" ""
)
...
_generate_srv_cpp(task
  "/home/arg/apriltag/src/task/srv/assignment.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/task)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/task\")")
  # install generated code
  install(
