...
(cl:defmethod cl:initialize-instance :after ((m <assignment-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'assignment-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name task-srv:<assignment-request> is deprecated: use task-srv:assignment-request instead.")))

(cl:ensure-generic-function 'tag1_id-val :lambda-list '(m))
(cl:defmethod tag1_id-val ((m <assignment-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task-srv:tag1_id-val is deprecated.  Use task-srv:tag1_id instead.")
  (tag1_id m))

(cl:ensure-generic-function 'tag2_id-val :lambda-list '(m))
(cl:defmethod tag2_id-val ((m <assignment-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task-srv:tag2_id-val is deprecated.  Use task-srv:tag2_id instead.")
  (tag2_id m))
...
(cl:defmethod cl:initialize-instance :after ((m <assignment-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'assignment-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name task-srv:<assignment-response> is deprecated: use task-srv:assignment-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <assignment-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task-srv:result-val is deprecated.  Use task-srv:result instead.")
  (result m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <assignment-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader task-srv:distance-val is deprecated.  Use task-srv:distance instead.")
  (distance m))
